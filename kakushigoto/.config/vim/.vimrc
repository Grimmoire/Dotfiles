...
map <S-h> <C-W><
map <S-l> <C-W>>
map <C-n> :!gnome-terminal --maximize --hide-menubar -e vim % <CR>

" Global Binds before bootstrap
let mapleader=' '
map <leader>v :vsp ~/.vimrc<CR>
map <leader>e :e ~/.vimrc<CR>
map <leader>[ :GoDefPop <CR>
map <leader>] :GoDef <CR>
map <leader>gt :!clear; go test ./... <CR>
map <leader>gg :!clear; go run main.go <CR>
map <leader>gF :GoFmt <CR>
map <leader>gf :GoBuild <CR>
map <leader>w :w <CR>
map <leader>gh :GoAlternate <CR>
...
noremap <Leader>gll :Git pull -r<CR>
